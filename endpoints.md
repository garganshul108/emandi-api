...
| ---------- | ------------------ | ----------------------- | -------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ | ------------------------------------ |
| **vendor** |
| PATCH      | /vendor            | Profile Edit            |                                  | type(string)<br/><br/>name(string)<br/><br/>state_id(valid int)<br/><br/>city_id(valid int)<br/><br/>pin_code(int)<br/><br/>address(string)<br/><br/>profile_picture(string) | vendor_token                   | full object of vendor enclosed by [] |
