...
router.get("/crop", [decodeToken, authVendor], (req, res) => {
  let vendor_id = req.actor.vendor_id;
  let sql = `select * from CROP where vendor_id=${vendor_id}`;
  return simpleGET(sql, req, res);
});

router.get("/crop/:crop_id", [decodeToken, authVendor], (req, res) => {
...
router.delete("/crop/:crop_id", (req, res) => {
